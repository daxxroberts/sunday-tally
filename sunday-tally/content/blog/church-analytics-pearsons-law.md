...
coverImageAlt: "An upward-trending ministry dashboard with a simple measure, report, improve loop"
ogImage: "/blog/church-analytics-pearsons-law-cover.png"
date: "2026-06-26"
...
<figure>
  <svg viewBox="0 0 560 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="The measure, report, improve loop">
    <rect width="560" height="200" fill="transparent"/>
    <g font-family="system-ui, sans-serif" font-size="15" text-anchor="middle">
      <rect x="30" y="80" width="120" height="44" rx="8" fill="#EEF2FF" stroke="#4F6EF7"/>
      <text x="90" y="107" fill="#1f2937">Measure</text>
      <rect x="220" y="80" width="120" height="44" rx="8" fill="#EEF2FF" stroke="#4F6EF7"/>
      <text x="280" y="107" fill="#1f2937">Report back</text>
      <rect x="410" y="80" width="120" height="44" rx="8" fill="#EEF2FF" stroke="#4F6EF7"/>
      <text x="470" y="107" fill="#1f2937">Improve</text>
      <path d="M150 102 H218" stroke="#4F6EF7" stroke-width="2" marker-end="url(#a)"/>
      <path d="M340 102 H408" stroke="#4F6EF7" stroke-width="2" marker-end="url(#a)"/>
      <path d="M470 124 V160 H90 V124" fill="none" stroke="#94a3b8" stroke-width="2" stroke-dasharray="4 4" marker-end="url(#a)"/>
    </g>
    <defs>
      <marker id="a" markerWidth="9" markerHeight="9" refX="6" refY="3" orient="auto"><path d="M0 0 L6 3 L0 6 z" fill="#4F6EF7"/></marker>
    </defs>
  </svg>
  <figcaption>The loop most churches leave open at the second step.</figcaption>
</figure>
...
*Daxx Roberts spent 13 years working in data analytics before founding Sunday Tally, affordable church analytics software he built after watching his own church's board run on hand-built spreadsheets and no database.*

<!--
HANDOFF (RANK -> GROVE / NOVA), strip before publish.
SOURCES (verify 200 + claim before publish):
- Pearson's Law definition, Karl Pearson attribution, Deming/Drucker implementation lineage. Retrieved 2026-06-26: https://execute90.com/articles/pearsons_law ; https://strategicdiscipline.positioningsystems.com/bid/41163/Pearson-s-Law-Revisited
- Hawthorne effect (Western Electric Hawthorne Works, 1920s). Britannica: https://www.britannica.com/science/Hawthorne-effect
EDITORIAL NOTE: Post deliberately avoids borrowed statistics. The church-tech niche lacks citable adoption data (only vendor marketing surfaced). Originality carried by PERSONAL EXPERIENCE + UNIQUE INSIGHT markers plus two named, verifiable principles. Optional: add one verified Lifeway/Barna stat to the intro during fact-check, or leave qualitative.
-->
