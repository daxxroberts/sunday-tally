  ...
  useEffect(() => {
    ...
    supabase.auth.getUser().then(async ({ data: { user } }) => {
      ...
      const { data: membership } = await supabase
        ...
        .select('role, church_id, churches(tracks_main_attendance,tracks_kids_attendance,tracks_youth_attendance,tracks_volunteers,tracks_responses,tracks_giving)')
      ...
      <div className="px-4 py-4 space-y-6">
        ...
        <div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl px-4 divide-y divide-gray-100">
            <Toggle checked={flags.tracks_main_attendance} onChange={v => setFlags(f => ({ ...f, tracks_main_attendance: v }))} label="Main" reason="Headcount for the main worship service. Turn off if you only track ministries (e.g. Kids/Youth) or parallel experiences." showImpact={false} />
