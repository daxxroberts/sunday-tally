...
## Corpus Check
- 220 files · ~266,894 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 843 nodes · 1351 edges · 25 communities detected
...
Cohesion: 0.05
Nodes (48): AiBudgetExhaustedError, anthropic(), assertBudget(), bucketForKind(), runToolLoop(), buildChurchContextPack(), formatContextPack(), attendanceByTemplateMonth() (+40 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (9): getDashboardHref(), isActive(), tabHref(), dayPhrase(), TrialBanner(), isPayReachable(), resolveChrome(), close() (+1 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (10): buildGroupColorMap(), colorFromHex(), extractRootKey(), styleForGroup(), fmt(), fmtNum(), fmtVal(), FourColRow() (+2 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (22): buildBoundaries(), buildWeeklyFrom(), delta(), emptyFourWin(), fetchDashboardData(), fetchEntriesPaged(), fourWinFromWeekly(), ratioFourWin() (+14 more)
...
Cohesion: 0.1
Nodes (27): aggregate(), bucketKey(), compileAndRun(), describeSpec(), detectFilterDrift(), explainQuery(), fetchPaged(), isObj() (+19 more)
...
Cohesion: 0.11
Nodes (15): aggregateMonths(), parseCount(), parseDateIso(), fetchGoogleSheetCsv(), getAllRows(), normalizeSource(), parseCsv(), stripBom() (+7 more)
...
Cohesion: 0.12
Nodes (16): buildColumnHeaders(), buildGrid(), buildRows(), flattenColumns(), formatMonth(), formatServiceDate(), formatWeek(), getMaxDepth() (+8 more)
